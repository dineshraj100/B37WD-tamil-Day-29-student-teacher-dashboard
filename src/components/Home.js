...
const Home = () => {
  return (
    <div>
      <img src={homepic} alt='teacher quote'></img>
          ...
          <Paragraph>
            <ul>
              <li>
                <p>
                  {' '}
                  Used the <b>Ant.design</b> library to create this project.
                </p>
              </li>
              <li>
                <p>
                  {' '}
                  This project do all<b> CRUD Operations</b> by using{' '}
                  <b> Context Api </b> from react .
                </p>
              </li>
            </ul>
          </Paragraph>
            ...
            <ul>
              <li>
                <p>
                  ...
                  the alternative to <b>"prop drilling"</b> or moving props from
              ...
              <li>
                <p>
                  Context API is a (kind of) new feature added in{' '}
                  <b>version 16.3</b> of React that allows one to share state
                  across the entire app (or part of it) lightly and with ease.
                </p>
              </li>
              <li>
                <p>
                  <h4>React.createContext()</h4> is all you need. It returns a
                  consumer and a provider. Provider is a component that as it's
                  names suggests provides the state to its children. It will
              ...
              <li>
                <Link href='https://reactjs.org/docs/context.html'>
                  Click me to kow more about Context Api
                </Link>
              </li>
            </ul>
          </Paragraph>
